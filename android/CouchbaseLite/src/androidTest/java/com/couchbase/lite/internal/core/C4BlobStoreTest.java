...
import static com.couchbase.lite.internal.core.C4Constants.C4DatabaseFlags.kC4DB_Create;
...
public class C4BlobStoreTest extends C4BaseTest {
    ...
    public void tearDown() throws Exception {
        ...
        if (blobDir != null && blobDir.exists()) { deleteRecursive(blobDir); }
        super.tearDown();
    }
    ...
    public void testWriteBlobWithStream() throws LiteCoreException {
        ...
        for (int i = 0; i < 1000; i++) { stream.write(format(Locale.ENGLISH, "This is line %03d.\n", i).getBytes()); }
