...
public class DocumentTest extends BaseTest {
    ...
    public void testCreateDocWithEmptyStringID() {
        MutableDocument doc1a = createMutableDocument("");
        assertNotNull(doc1a);
        try {
            save(doc1a);
            fail();
    ...
    public void testSetString() throws CouchbaseLiteException {
        ...
        // -- setString
        // save
        MutableDocument mDoc2 = createMutableDocument("doc2");
    ...
    public void testSetNumber() throws CouchbaseLiteException {
        ...
        // -- setInt
        // save
        MutableDocument mDoc3 = createMutableDocument("doc3");
        ...
        // -- setLong
        // save
        MutableDocument mDoc4 = createMutableDocument("doc4");
        ...
        // -- setFloat
        // save
        MutableDocument mDoc5 = createMutableDocument("doc5");
        ...
        // -- setDouble
        // save
        MutableDocument mDoc6 = createMutableDocument("doc6");
    ...
    public void testSetGetFloatNumbers() throws CouchbaseLiteException {
        ...
        // -- setDouble
        MutableDocument doc3 = createMutableDocument("doc3");
    ...
    public void testDictionaryAfterDeleteDocument() throws CouchbaseLiteException {
        ...
        MutableDocument mDoc = createMutableDocument("doc1", dict);
        Document doc = save(mDoc);
    ...
    @Test
    public void testSetExpirationOnDoc() throws CouchbaseLiteException, Exception {
        ...
        MutableDocument doc1b = new MutableDocument("doc2");
        doc1b.setInt("answer", 12);
        doc1b.setValue("question", "What is six plus six?");
        save(doc1b);
