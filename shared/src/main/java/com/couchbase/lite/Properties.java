...
/**
 * Properties defines a JSON-compatible object, much like a Map (DictionaryInterface) but with
...
//     * SubDocument, and Blob. List (Array) and Map (DictionaryInterface) must contain only the above types.
...
//
//    /**
//     * Get a property's value as a Subdocument, which is a mapping object of a DictionaryInterface
//     * value to provide property type accessors.
//     * Returns null if the property doesn't exists, or its value is not a DictionaryInterface.
//     *
//     * @param key The key to access the value for.
//     */
