...
// ----------------------------------------------------------------------------
// com_couchbase_lite_internal_core_C4Listener
// ----------------------------------------------------------------------------

/*
 * Class:     com_couchbase_lite_internal_core_C4Listener
 * Method:    availableAPIs
 * Signature: ()I
 */
JNIEXPORT jint JNICALL
Java_com_couchbase_lite_internal_core_C4Listener_availableAPIs(JNIEnv *env, jclass clazz) {
...
Java_com_couchbase_lite_internal_core_C4Listener_start(JNIEnv *env, jclass clazz, jint port, jint apis,
...
Java_com_couchbase_lite_internal_core_C4Listener_free(JNIEnv *env, jclass clazz, jlong listener) {
    if (!listener) return;
...
Java_com_couchbase_lite_internal_core_C4Listener_shareDB(JNIEnv *env, jclass clazz, jlong listener,
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_couchbase_lite_internal_core_C4Listener_unshareDB(JNIEnv *env, jclass clazz, jlong listener,
                                                 jstring jname) {
    if (!listener) return false;
...
Java_com_couchbase_lite_internal_core_C4Listener_uriNameFromPath(JNIEnv *env, jclass clazz, jstring jpath) {
