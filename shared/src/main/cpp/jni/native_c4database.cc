...
#include "com_couchbase_lite_internal_C4Database.h"
...
// ----------------------------------------------------------------------------
// com_couchbase_lite_internal_C4Database
// ----------------------------------------------------------------------------
...
Java_com_couchbase_lite_internal_C4Database_open(JNIEnv *env, jclass clazz, jstring jpath,
                                            jint jflags,
...
Java_com_couchbase_lite_internal_C4Database_copy(JNIEnv *env, jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_free(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_close(JNIEnv *env, jclass clazz, jlong jdb) {
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_delete(JNIEnv *env, jclass clazz, jlong jdb) {
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_deleteAtPath(JNIEnv *env, jclass clazz, jstring jpath) {
    jstringSlice path(env, jpath);
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_rekey(JNIEnv *env, jclass clazz, jlong jdb,
                                             jint encryptionAlg, jbyteArray encryptionKey) {
    C4EncryptionKey key;
...
Java_com_couchbase_lite_internal_C4Database_getPath(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_C4Database_getConfig(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_C4Database_getDocumentCount(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_C4Database_getLastSequence(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_C4Database_nextDocExpiration(JNIEnv *env, jclass clazz, jlong jdb) {
...
Java_com_couchbase_lite_internal_C4Database_purgeExpiredDocs(JNIEnv *env, jclass clazz, jlong jdb) {
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_purgeDoc(JNIEnv *env, jclass clazz,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_couchbase_lite_internal_C4Database_getMaxRevTreeDepth(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_setMaxRevTreeDepth(JNIEnv *env, jclass clazz, jlong jdb,
...
Java_com_couchbase_lite_internal_C4Database_getPublicUUID(JNIEnv *env, jclass clazz, jlong jdb) {
    C4UUID uuid;
    C4Error error;
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_com_couchbase_lite_internal_C4Database_getPrivateUUID(JNIEnv *env, jclass clazz, jlong jdb) {
    C4UUID uuid;
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_compact(JNIEnv *env, jclass clazz, jlong jdb) {
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_beginTransaction(JNIEnv *env, jclass clazz, jlong jdb) {
    C4Error error;
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_endTransaction(JNIEnv *env, jclass clazz, jlong jdb,
                                                      jboolean jcommit) {
    C4Error error;
...
Java_com_couchbase_lite_internal_C4Database_isInTransaction(JNIEnv *env, jclass clazz, jlong jdb) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_rawFree(JNIEnv *env, jclass clazz, jlong jrawDoc) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_C4Database_rawGet(JNIEnv *env, jclass clazz, jlong jdb,
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_C4Database_rawPut(JNIEnv *env, jclass clazz, jlong jdb,
                                              jstring jstoreName,
