 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_couchbase_lite_internal_fleece_FLEncoder_init
  (JNIEnv *, jclass);
 ...
 */
JNIEXPORT void JNICALL Java_com_couchbase_lite_internal_fleece_FLEncoder_setExtraInfo
 ...
 */
JNIEXPORT jobject JNICALL Java_com_couchbase_lite_internal_fleece_FLEncoder_getExtraInfo
  (JNIEnv *, jclass, jlong);
