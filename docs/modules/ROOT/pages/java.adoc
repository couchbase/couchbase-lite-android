...
----
dependencies {
    compile 'com.couchbase.lite:couchbase-lite-android-ee:2.1DB001'
}
----
...
- http://docs.couchbase.com/mobile/2.0/couchbase-lite-java/[Java SDK API References]
- http://docs.couchbase.com/mobile/2.1/couchbase-lite-java/db001/[Java SDK API References]
...
[source,java]
----
include::{examplesdir}/ReplicationAPITest.java[tags=replication-reset-checkpoint]
----
